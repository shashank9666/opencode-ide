...
Enable the experimental umbrella flag
...
Enable background subagent tasks

`OPENCODE_EXPERIMENTAL_EVENT_SYSTEM`

boolean

Enable experimental event system

`OPENCODE_EXPERIMENTAL_NATIVE_LLM`

boolean

Enable native LLM request path

`OPENCODE_EXPERIMENTAL_PARALLEL`

boolean

Enable parallel web search execution

`OPENCODE_EXPERIMENTAL_SCOUT`

boolean

Enable Scout subagent
