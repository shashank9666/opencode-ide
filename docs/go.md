...
The [model id](/docs/config/#models) in your OpenCode config uses the format `opencode-go/<model-id>`. For example, for Kimi K2.7 Code, you would use `opencode-go/kimi-k2.7-code` in your config.
