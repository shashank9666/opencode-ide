...
#### [Option A — SuperGrok OAuth (browser login)](#option-a--supergrok-oauth-browser-login)
...
#### [Option B — SuperGrok device-code (headless / remote server / VPS)](#option-b--supergrok-device-code-headless--remote-server--vps)
...
#### [Option C — API key](#option-c--api-key)
