...
2.  **[Contact us](mailto:help@anoma.ly)** to discuss pricing and implementation options.
...
We use a per-seat model for OpenCode Enterprise. If you have your own LLM gateway, we do not charge for tokens used. For further details about pricing and implementation options, **[contact us](mailto:help@anoma.ly)**.

* * *

## [Deployment](#deployment)

Once you have completed your trial and you are ready to use OpenCode at your organization, you can **[contact us](mailto:help@anoma.ly)** to discuss pricing and implementation options.
...
This is currently on our roadmap. If you’re interested, **[let us know](mailto:help@anoma.ly)**.
...
Then **[contact us](mailto:help@anoma.ly)** to discuss pricing and implementation options.

How does enterprise pricing work?

We offer per-seat enterprise pricing. If you have your own LLM gateway, we do not charge for tokens used. For further details, **[contact us](mailto:help@anoma.ly)** for a custom quote based on your organization’s needs.
