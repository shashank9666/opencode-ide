  ...
  <nav class="flex flex-col gap-1">
    ...
    <Show when={props.showNew()}>
      <div class="group/session relative w-full min-w-0 rounded-md cursor-default transition-colors pl-2 pr-3 hover:bg-surface-raised-base-hover [&:has(:focus-visible)]:bg-surface-raised-base-hover has-[.active]:bg-surface-base-active">
        <A
          href={`/${props.slug()}/ide`}
          class="flex items-center gap-2 min-w-0 w-full text-left focus:outline-none py-1"
        >
          <div class="shrink-0 size-6 flex items-center justify-center">
            <svg class="size-4 text-icon-weak" viewBox="0 0 16 16" fill="currentColor">
              <path d="M4.5 2A1.5 1.5 0 0 0 3 3.5v9A1.5 1.5 0 0 0 4.5 14h7a1.5 1.5 0 0 0 1.5-1.5v-7L9.5 2H4.5ZM5 4h1.5v1.5H5V4Zm0 2.5h1.5V8H5V6.5Zm0 2.5h1.5v1.5H5V9Zm3-5.5h1.5v3H8V3.5Zm0 4h1.5v1.5H8V7.5Zm0 2.5h1.5v1.5H8V10Z"/>
            </svg>
          </div>
          <span class="text-14-regular text-text-strong min-w-0 flex-1 truncate">IDE</span>
        </A>
      </div>
    </Show>
