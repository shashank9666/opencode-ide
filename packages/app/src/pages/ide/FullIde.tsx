...
export default function FullIde() {
  ...
  const ideActions: Partial<IdeActions> = {
    ...
    find: () => { editorInstance()?.getAction('actions.find')?.run() },
    replace: () => { editorInstance()?.getAction('editor.action.startFindReplaceAction')?.run() },
    findInFiles: () => toggleLeftPanel("search"),
    toggleLineComment: () => { editorInstance()?.getAction('editor.action.commentLine')?.run() },
    toggleBlockComment: () => { editorInstance()?.getAction('editor.action.blockComment')?.run() },
    
    // Selection
    selectAll: () => { editorInstance()?.getAction('editor.action.selectAll')?.run() },
    expandSelection: () => { editorInstance()?.getAction('editor.action.smartSelect.expand')?.run() },
    shrinkSelection: () => { editorInstance()?.getAction('editor.action.smartSelect.shrink')?.run() },
    copyLineUp: () => { editorInstance()?.getAction('editor.action.copyLinesUpAction')?.run() },
    copyLineDown: () => { editorInstance()?.getAction('editor.action.copyLinesDownAction')?.run() },
    moveLineUp: () => { editorInstance()?.getAction('editor.action.moveLinesUpAction')?.run() },
    moveLineDown: () => { editorInstance()?.getAction('editor.action.moveLinesDownAction')?.run() },
    duplicateSelection: () => { editorInstance()?.getAction('editor.action.duplicateSelection')?.run() },
    addCursorAbove: () => { editorInstance()?.getAction('editor.action.insertCursorAbove')?.run() },
    addCursorBelow: () => { editorInstance()?.getAction('editor.action.insertCursorBelow')?.run() },
    addCursorsToLineEnds: () => { editorInstance()?.getAction('editor.action.insertCursorAtEndOfEachLineSelected')?.run() },
    addNextOccurrence: () => { editorInstance()?.getAction('editor.action.addSelectionToNextFindMatch')?.run() },
    addPreviousOccurrence: () => { editorInstance()?.getAction('editor.action.addSelectionToPreviousFindMatch')?.run() },
    selectAllOccurrences: () => { editorInstance()?.getAction('editor.action.selectHighlights')?.run() },
    ...
    toggleExtensions: () => showToast({ variant: "default", title: "Extensions", description: "No extensions currently active." }),
    toggleChat: () => { if (rightPanel()?.id === "ai-chat") panelManager.hidePanel("ai-chat"); else panelManager.showPanel("ai-chat") },
    toggleBrowser: () => showToast({ variant: "default", title: "Browser", description: "Browser preview is coming in a future update." }),
    ...
    toggleWordWrap: () => { editorInstance()?.getAction('editor.action.toggleWordWrap')?.run() },
