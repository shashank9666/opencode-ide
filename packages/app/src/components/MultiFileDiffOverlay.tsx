      ...
      <div class="absolute top-4 right-4 z-50 flex flex-col gap-2 bg-surface-raised-base border border-border-base rounded-xl shadow-xl p-3 w-80 animate-in fade-in slide-in-from-top-4 duration-200">
        ...
        <div class="flex items-center gap-2">
          <div class="flex items-center gap-1 text-text-weak flex-1">
            <IconButton icon="file" size="small" variant="ghost" class="size-6" />
            <IconButton icon="git-commit" size="small" variant="ghost" class="size-6" />
            <IconButton icon="globe" size="small" variant="ghost" class="size-6" />
            <IconButton icon="edit-2" size="small" variant="ghost" class="size-6" />
          </div>
          <button 
          ...
          >
            <Icon name="git-pull-request" class="size-3.5" />
            Review Changes
          </button>
        </div>
