export const dict = {
  ...
  "onboarding.welcome.title": "Welcome to OpenCode",
  "onboarding.welcome.description": "Let's get you set up in a few quick steps.",
  "onboarding.step.connectProvider.title": "Connect an AI provider",
  "onboarding.step.connectProvider.description": "Connect at least one AI provider to start coding with AI assistance.",
  "onboarding.step.openProject.title": "Open a project",
  "onboarding.step.openProject.description": "Open a local project to start working with your code.",
  "onboarding.step.firstPrompt.title": "Try your first prompt",
  "onboarding.step.firstPrompt.description": "Ask the AI to help you with a task in your project.",
  "onboarding.step.complete.title": "You're all set!",
  "onboarding.step.complete.description": "You're ready to start coding with AI. Open a project and ask your first question.",
